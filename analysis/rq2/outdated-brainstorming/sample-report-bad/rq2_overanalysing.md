# RQ2 - Example Outputs _(illustrative)_
...
_(table: `per_session`, 144 rows)_
...
_(per-session average vs end-of-study score)_

| per-session <-> end-of-study | r (correlation) | verdict           |
| ---------------------------- | --------------- | ----------------- |
| paas effort                  | 0.87            | trust light items |
| germane                      | 0.79            | trust light items |
| extraneous                   | 0.69            | partial           |
| effectiveness                | 0.52            | partial           |
| enjoyability                 | 0.86            | trust light items |
| adoption                     | 0.64            | partial           |

(r closer to 1 = the light rating tracked the full)
